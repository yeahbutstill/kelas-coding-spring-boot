...
public class AfterAopAspect {
    ...
    @AfterReturning(value = "execution(* com.yeahbutstilll.spring.aop.springaop.business.*.*(..))",
            returning = "result")
    public void afterReturning(JoinPoint joinPoint, Object result) {
        logger.info("{} returned with value {}", joinPoint, result);
    }

    @After(value = "execution(* com.yeahbutstill.spring.aop.springaop.business.*.*(..))")
...
public class MethodExecutionCalculationAspect {
	...
	@Around("execution(* com.yeahbutstilll.spring.aop.springaop.business.*.*(..))")
...
public class UserAccessAspect {
	...
	//execution(* PACKAGE.*.*(..))
	//Weaving & Weaver
	@Before("execution(* com.yeahbutstilll.spring.aop.springaop.data.*.*(..))")
