...
public class CommonJoinPointConfig {
	...
	@Pointcut("within(com.yeahbutstilll.spring.aop.springaop.data..*)")
	public void dataLayerExecutionWithWithin(){}

	@Pointcut("@annotation(com.yeahbutstilll.spring.aop.springaop.aspect.TrackTime)")
...
public class MethodExecutionCalculationAspect {
	...
	@Around("com.yeahbutstilll.spring.aop.springaop.aspect.CommonJoinPointConfig.trackTimeAnnotation()")
